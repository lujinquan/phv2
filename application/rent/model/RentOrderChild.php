...
class RentOrderChild extends Model
{
    ...
    public function detail($id)
    {
        ...
        //halt($row);
        $row['pay_info'] = Db::name('rent_order')->where([['rent_order_status','eq',1],['house_id','eq',$row['house_id']],['tenant_id','eq',$row['tenant_id']]])->field('sum(rent_order_receive-rent_order_paid) as total_unpaid_rent,sum(rent_order_paid) as total_paid_rent')->find();
