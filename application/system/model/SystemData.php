...
class SystemData extends Model
{
    ...
    public function queryBan($queryWhere)
    {
        ...
        if(isset($queryWhere['change_type']) && $queryWhere['change_type']){ //如果异动类型有值，则验证房屋是否符合暂停计租要求
            switch ($queryWhere['change_type']) {
                ...
                case 10: //管段调整
                    ...
                    $tempApplyBanidArr = Db::name('change_inst')->where([['change_status','>',1],['dtime','eq',0]])->column('ban_ids');
                ...
                case 14: //楼栋调整
                    $where[] = ['ban_status','eq',1];
                    $applyBanidArr = Db::name('change_ban')->where([['change_status','>',1],['dtime','eq',0]])->column('ban_id');
                    break;
                case 17: //别字更正
                    break;
                case 18: //发租约
        ...
        $fields = 'ban_id,ban_use_id,(ban_civil_holds + ban_party_holds + ban_career_holds) as ban_holds,ban_number,ban_inst_id,ban_address,ban_owner_id,ban_damage_id,ban_struct_id,ban_civil_area,ban_party_area,ban_career_area,(ban_civil_area + ban_party_area + ban_career_area) as ban_area,ban_civil_num,ban_party_num,ban_career_num,(ban_civil_num+ban_party_num+ban_career_num) as ban_num,ban_civil_rent,ban_party_rent,ban_career_rent,(ban_civil_rent + ban_party_rent + ban_career_rent) as ban_rent,ban_civil_oprice,ban_party_oprice,ban_career_oprice,(ban_civil_oprice+ban_party_oprice+ban_career_oprice) as ban_oprice,ban_use_area,ban_floors,ban_units';
        $data = [];
