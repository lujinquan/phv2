        ...
        foreach ($ownertypes as $owners) { //处理市、区、代、自、托
            for ($j = 4; $j < 34; $j++) { //每个管段，从4开始……
                ...
                if(substr($cacheDate,4,2) != '01'){
                    ...
                    $result[$owners][$j][0][4] = bcmul('0.4' , $result[$owners][$j][0][1] , 3);
                    $result[$owners][$j][0][5] = bcmul('0.4' , $result[$owners][$j][0][2] , 3);
                    $result[$owners][$j][0][6] = bcmul('0.4' , $result[$owners][$j][0][3] , 3);
                    $result[$owners][$j][0][7] = bcmul('0.6' , $result[$owners][$j][0][1] , 3);
                    $result[$owners][$j][0][8] = bcmul('0.6' , $result[$owners][$j][0][2] , 3);
                    $result[$owners][$j][0][9] = bcmul('0.6' , $result[$owners][$j][0][3] , 3);
                ...
                $result[$owners][$j][2][4] = bcmul('0.4' , $result[$owners][$j][2][1] , 3);
                $result[$owners][$j][2][5] = bcmul('0.4' , $result[$owners][$j][2][2] , 3);
                $result[$owners][$j][2][6] = bcmul('0.4' , $result[$owners][$j][2][3] , 3);
                $result[$owners][$j][2][7] = bcmul('0.6' , $result[$owners][$j][2][1] , 3);
                $result[$owners][$j][2][8] = bcmul('0.6' , $result[$owners][$j][2][2] , 3);
                $result[$owners][$j][2][9] = bcmul('0.6' , $result[$owners][$j][2][3] , 3);
                ...
                $result[$owners][$j][3][4] = bcmul('0.4' , $result[$owners][$j][3][1] , 3);
                $result[$owners][$j][3][5] = bcmul('0.4' , $result[$owners][$j][3][2] , 3);
                $result[$owners][$j][3][6] = bcmul('0.4' , $result[$owners][$j][3][3] , 3);
                $result[$owners][$j][3][7] = bcmul('0.6' , $result[$owners][$j][3][1] , 3);
                $result[$owners][$j][3][8] = bcmul('0.6' , $result[$owners][$j][3][2] , 3);
                $result[$owners][$j][3][9] = bcmul('0.6' , $result[$owners][$j][3][3] , 3);
                ...
                $result[$owners][$j][4][4] = bcmul('0.4' , $result[$owners][$j][4][1] , 3);
                $result[$owners][$j][4][5] = bcmul('0.4' , $result[$owners][$j][4][2] , 3);
                $result[$owners][$j][4][6] = bcmul('0.4' , $result[$owners][$j][4][3] , 3);
                $result[$owners][$j][4][7] = bcmul('0.6' , $result[$owners][$j][4][1] , 3);
                $result[$owners][$j][4][8] = bcmul('0.6' , $result[$owners][$j][4][2] , 3);
                $result[$owners][$j][4][9] = bcmul('0.6' , $result[$owners][$j][4][3] , 3);
                ...
                $result[$owners][$j][5][4] = bcmul('0.4' , $result[$owners][$j][5][1] , 3);
                $result[$owners][$j][5][5] = bcmul('0.4' , $result[$owners][$j][5][2] , 3);
                $result[$owners][$j][5][6] = bcmul('0.4' , $result[$owners][$j][5][3] , 3);
                $result[$owners][$j][5][7] = bcmul('0.6' , $result[$owners][$j][5][1] , 3);
                $result[$owners][$j][5][8] = bcmul('0.6' , $result[$owners][$j][5][2] , 3);
                $result[$owners][$j][5][9] = bcmul('0.6' , $result[$owners][$j][5][3] , 3);
                ...
                $result[$owners][$j][6][4] = bcmul('0.4' , $result[$owners][$j][6][1] , 3);
                $result[$owners][$j][6][5] = bcmul('0.4' , $result[$owners][$j][6][2] , 3);
                $result[$owners][$j][6][6] = bcmul('0.4' , $result[$owners][$j][6][3] , 3);
                $result[$owners][$j][6][7] = bcmul('0.6' , $result[$owners][$j][6][1] , 3);
                $result[$owners][$j][6][8] = bcmul('0.6' , $result[$owners][$j][6][2] , 3);
                $result[$owners][$j][6][9] = bcmul('0.6' , $result[$owners][$j][6][3] , 3);
                ...
                $result[$owners][$j][7][4] = bcmul('0.4' , $result[$owners][$j][7][1] , 3);
                $result[$owners][$j][7][5] = bcmul('0.4' , $result[$owners][$j][7][2] , 3);
                $result[$owners][$j][7][6] = bcmul('0.4' , $result[$owners][$j][7][3] , 3);
                $result[$owners][$j][7][7] = bcmul('0.6' , $result[$owners][$j][7][1] , 3);
                $result[$owners][$j][7][8] = bcmul('0.6' , $result[$owners][$j][7][2] , 3);
                $result[$owners][$j][7][9] = bcmul('0.6' , $result[$owners][$j][7][3] , 3);
                ...
                $result[$owners][$j][1][4] = bcmul('0.4' , $result[$owners][$j][1][1] , 3);
                $result[$owners][$j][1][5] = bcmul('0.4' , $result[$owners][$j][1][2] , 3);
                $result[$owners][$j][1][6] = bcmul('0.4' , $result[$owners][$j][1][3] , 3);
                $result[$owners][$j][1][7] = bcmul('0.6' , $result[$owners][$j][1][1] , 3);
                $result[$owners][$j][1][8] = bcmul('0.6' , $result[$owners][$j][1][2] , 3);
                $result[$owners][$j][1][9] = bcmul('0.6' , $result[$owners][$j][1][3] , 3);
                ...
                $result[$owners][$j][8][4] = bcmul('0.4' , $result[$owners][$j][8][1] , 3);
                $result[$owners][$j][8][5] = bcmul('0.4' , $result[$owners][$j][8][2] , 3);
                $result[$owners][$j][8][6] = bcmul('0.4' , $result[$owners][$j][8][3] , 3);
                $result[$owners][$j][8][7] = bcmul('0.6' , $result[$owners][$j][8][1] , 3);
                $result[$owners][$j][8][8] = bcmul('0.6' , $result[$owners][$j][8][2] , 3);
                $result[$owners][$j][8][9] = bcmul('0.6' , $result[$owners][$j][8][3] , 3);
                ...
                $result[$owners][$j][10][4] = bcmul('0.4' , $result[$owners][$j][10][1] , 3);
                $result[$owners][$j][10][5] = bcmul('0.4' , $result[$owners][$j][10][2] , 3);
                $result[$owners][$j][10][6] = bcmul('0.4' , $result[$owners][$j][10][3] , 3);
                $result[$owners][$j][10][7] = bcmul('0.6' , $result[$owners][$j][10][1] , 3);
                $result[$owners][$j][10][8] = bcmul('0.6' , $result[$owners][$j][10][2] , 3);
                $result[$owners][$j][10][9] = bcmul('0.6' , $result[$owners][$j][10][3] , 3);
                ...
                $result[$owners][$j][11][4] = bcmul('0.4' , $result[$owners][$j][11][1] , 3);
                $result[$owners][$j][11][5] = bcmul('0.4' , $result[$owners][$j][11][2] , 3);
                $result[$owners][$j][11][6] = bcmul('0.4' , $result[$owners][$j][11][3] , 3);
                $result[$owners][$j][11][7] = bcmul('0.6' , $result[$owners][$j][11][1] , 3);
                $result[$owners][$j][11][8] = bcmul('0.6' , $result[$owners][$j][11][2] , 3);
                $result[$owners][$j][11][9] = bcmul('0.6' , $result[$owners][$j][11][3] , 3);
                ...
                $result[$owners][$j][12][4] = bcmul('0.4' , $result[$owners][$j][12][1] , 3);
                $result[$owners][$j][12][5] = bcmul('0.4' , $result[$owners][$j][12][2] , 3);
                $result[$owners][$j][12][6] = bcmul('0.4' , $result[$owners][$j][12][3] , 3);
                $result[$owners][$j][12][7] = bcmul('0.6' , $result[$owners][$j][12][1] , 3);
                $result[$owners][$j][12][8] = bcmul('0.6' , $result[$owners][$j][12][2] , 3);
                $result[$owners][$j][12][9] = bcmul('0.6' , $result[$owners][$j][12][3] , 3);
                ...
                $result[$owners][$j][14][4] = bcmul('0.4' , $result[$owners][$j][14][1] , 3);
                $result[$owners][$j][14][5] = bcmul('0.4' , $result[$owners][$j][14][2] , 3);
                $result[$owners][$j][14][6] = bcmul('0.4' , $result[$owners][$j][14][3] , 3);
                $result[$owners][$j][14][7] = bcmul('0.6' , $result[$owners][$j][14][1] , 3);
                $result[$owners][$j][14][8] = bcmul('0.6' , $result[$owners][$j][14][2] , 3);
                $result[$owners][$j][14][9] = bcmul('0.6' , $result[$owners][$j][14][3] , 3);
                ...
                $result[$owners][$j][16][4] = bcmul('0.4' , $result[$owners][$j][16][1] , 3);
                $result[$owners][$j][16][5] = bcmul('0.4' , $result[$owners][$j][16][2] , 3);
                $result[$owners][$j][16][6] = bcmul('0.4' , $result[$owners][$j][16][3] , 3);
                $result[$owners][$j][16][7] = bcmul('0.6' , $result[$owners][$j][16][1] , 3);
                $result[$owners][$j][16][8] = bcmul('0.6' , $result[$owners][$j][16][2] , 3);
                $result[$owners][$j][16][9] = bcmul('0.6' , $result[$owners][$j][16][3] , 3);
                ...
                $result[$owners][$j][15][4] = bcmul('0.4' , $result[$owners][$j][15][1] , 3);
                $result[$owners][$j][15][5] = bcmul('0.4' , $result[$owners][$j][15][2] , 3);
                $result[$owners][$j][15][6] = bcmul('0.4' , $result[$owners][$j][15][3] , 3);
                $result[$owners][$j][15][7] = bcmul('0.6' , $result[$owners][$j][15][1] , 3);
                $result[$owners][$j][15][8] = bcmul('0.6' , $result[$owners][$j][15][2] , 3);
                $result[$owners][$j][15][9] = bcmul('0.6' , $result[$owners][$j][15][3] , 3);
                ...
                $result[$owners][$j][9][4] = bcmul('0.4' , $result[$owners][$j][9][1] , 3);
                $result[$owners][$j][9][5] = bcmul('0.4' , $result[$owners][$j][9][2] , 3);
                $result[$owners][$j][9][6] = bcmul('0.4' , $result[$owners][$j][9][3] , 3);
                $result[$owners][$j][9][7] = bcmul('0.6' , $result[$owners][$j][9][1] , 3);
                $result[$owners][$j][9][8] = bcmul('0.6' , $result[$owners][$j][9][2] , 3);
                $result[$owners][$j][9][9] = bcmul('0.6' , $result[$owners][$j][9][3] , 3);
                ...
                $result[$owners][$j][17][4] = bcmul('0.4' , $result[$owners][$j][17][1] , 3);
                $result[$owners][$j][17][5] = bcmul('0.4' , $result[$owners][$j][17][2] , 3);
                $result[$owners][$j][17][6] = bcmul('0.4' , $result[$owners][$j][17][3] , 3);
                $result[$owners][$j][17][7] = bcmul('0.6' , $result[$owners][$j][17][1] , 3);
                $result[$owners][$j][17][8] = bcmul('0.6' , $result[$owners][$j][17][2] , 3);
                $result[$owners][$j][17][9] = bcmul('0.6' , $result[$owners][$j][17][3] , 3);
                ...
                $result[$owners][$j][18][4] = bcmul('0.4' , $result[$owners][$j][18][1] , 3);
                $result[$owners][$j][18][5] = bcmul('0.4' , $result[$owners][$j][18][2] , 3);
                $result[$owners][$j][18][6] = bcmul('0.4' , $result[$owners][$j][18][3] , 3);
                $result[$owners][$j][18][7] = bcmul('0.6' , $result[$owners][$j][18][1] , 3);
                $result[$owners][$j][18][8] = bcmul('0.6' , $result[$owners][$j][18][2] , 3);
                $result[$owners][$j][18][9] = bcmul('0.6' , $result[$owners][$j][18][3] , 3);
                ...
                if(substr($cacheDate,4,2) != '01'){
                    ...
                    $result[$owners][$j][19][4] = bcmul('0.4' , $result[$owners][$j][19][1] , 3);
                    $result[$owners][$j][19][5] = bcmul('0.4' , $result[$owners][$j][19][2] , 3);
                    $result[$owners][$j][19][6] = bcmul('0.4' , $result[$owners][$j][19][3] , 3);
                    $result[$owners][$j][19][7] = bcmul('0.6' , $result[$owners][$j][19][1] , 3);
                    $result[$owners][$j][19][8] = bcmul('0.6' , $result[$owners][$j][19][2] , 3);
                    $result[$owners][$j][19][9] = bcmul('0.6' , $result[$owners][$j][19][3] , 3);
                ...
                $result[$owners][$j][20][4] = bcmul('0.4' , $result[$owners][$j][20][1] , 3);
                $result[$owners][$j][20][5] = bcmul('0.4' , $result[$owners][$j][20][2] , 3);
                $result[$owners][$j][20][6] = bcmul('0.4' , $result[$owners][$j][20][3] , 3);
                $result[$owners][$j][20][7] = bcmul('0.6' , $result[$owners][$j][20][1] , 3);
                $result[$owners][$j][20][8] = bcmul('0.6' , $result[$owners][$j][20][2] , 3);
                $result[$owners][$j][20][9] = bcmul('0.6' , $result[$owners][$j][20][3] , 3);
