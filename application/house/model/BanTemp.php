...
class BanTemp extends SystemBase
{
	// 设置模型名称
    protected $name = 'ban_temp';
    // 设置主键
    protected $pk = 'ban_id';
    // 定义时间戳字段名
    ...
    {
        return $this->hasMany('ban_temp', 'ban_number', 'ban_number')->bind('ban_owner_id,ban_inst_id,ban_address,ban_units,ban_floors');
    }
