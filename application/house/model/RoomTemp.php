...
class RoomTemp extends SystemBase
{
	// 设置模型名称
    protected $name = 'room_temp';
    // 设置主键
    ...
    public function ban()
    {
        return $this->belongsTo('ban_temp', 'ban_id', 'ban_id')->bind('ban_owner_id,ban_number,ban_inst_id,ban_address,ban_units,ban_floors,ban_struct_id,ban_is_first');
    }
