...
class Lease extends Admin
{
    ...
    public function index()
    {
    	if ($this->request->isAjax()) {
            ...
            //halt($where);
            $fields = "a.id,a.change_order_number,a.szno,from_unixtime(a.last_print_time, '%Y-%m-%d') as last_print_time,b.house_use_id,b.house_area,b.house_oprice,a.tenant_name,c.tenant_tel,c.tenant_card,d.ban_address,d.ban_owner_id,d.ban_inst_id";
            $data = [];
