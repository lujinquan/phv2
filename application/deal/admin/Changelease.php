...
//        halt($row);
    ...
    public function record()
    {
        if ($this->request->isAjax()) {
            ...
            $fields = "a.id,a.change_order_number,a.tenant_name,from_unixtime(a.ctime, '%Y-%m-%d') as ctime,from_unixtime(a.ftime, '%Y-%m-%d') as fdate,a.ftime,a.change_status,a.entry_date,b.house_number,a.is_back,a.is_valid,b.house_use_id,d.ban_address,d.ban_struct_id,d.ban_damage_id,d.ban_owner_id,d.ban_inst_id";
            $data = [];
    ...
    public function del()
    {
        ...
        if($row['change_status'] == 2 && !$row['print_times']){
            $row->dtime = time();
            $row->save();
