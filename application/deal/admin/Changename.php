...
class Changename extends Admin
{
    ...
    public function record()
    {
        if ($this->request->isAjax()) {
            ...
            //halt($where);
            $fields = "a.id,a.change_order_number,a.old_tenant_name,a.new_tenant_name,from_unixtime(a.ctime, '%Y-%m-%d') as ctime,from_unixtime(a.ftime, '%Y-%m-%d') as ftime,a.change_status,a.entry_date,a.is_back,a.entry_date,b.house_use_id,d.ban_address,d.ban_owner_id,d.ban_inst_id";
            $data = [];
