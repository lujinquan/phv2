...
class Changecancel extends Admin
{
    ...
    public function record()
    {
        if ($this->request->isAjax()) {
            ...
            $fields = "a.id,a.is_back,a.change_order_number,a.cancel_type,a.cancel_rent,a.cancel_area,a.cancel_use_area,a.cancel_oprice,from_unixtime(a.ctime, '%Y-%m-%d') as ctime,from_unixtime(a.ftime, '%Y-%m-%d') as ftime,a.change_status,d.ban_address,d.ban_owner_id,d.ban_inst_id";
            $data = [];
