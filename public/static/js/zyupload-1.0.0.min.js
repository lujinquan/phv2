...
//					edit             : true,  						      // 是否可以编辑文件（裁剪）
			...
			this.createHtml = function(){
				...
				if(para.dragDrop){
		            ...
		            html += '				<div class="btns">';
		            html += '					<div class="webuploader_pick">点击上传</div>';
		           /* html += '					<div class="upload_btn">开始上传</div>'; */
		            html += '				</div>';
		            html += '			</div>';
					html += '			<div id="preview" class="upload_preview" name="ban_upload"></div>';
					html += '		</div>';
...
/* 		            html += '					<div class="upload_btn">开始上传</div>'; */
		            html += '				</div>';
		            html += '			</div>';
		            html += '			<div id="preview" class="upload_preview" name="ban_upload">';
