...
(function(){
    ...
    Cluster.prototype.addLabel = function (marker) {
        ...
        var content = '<span style="color:'+this._styles[0].backgroundColor+'"><i class="fa fa-map-marker"></i></span>'+'<p style="padding:0px 13px;text-align:center;margin-top:5px;">'+ marker.getLabel().content +'</p>';
